                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'publish_date'">{{ trans('admin.article.columns.publish_date') }}</th>
                                    <th is='sortable' :column="'article_filename'">{{ trans('admin.article.columns.article_filename') }}</th>
                                    <th is='sortable' :column="'confirm'">{{ trans('admin.article.columns.confirm') }}</th>
