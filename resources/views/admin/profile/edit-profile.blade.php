                ...
                <form class="form-horizontal form-edit" method="post" @submit.prevent="onSubmit" :action="this.action">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('birthdate'), 'has-success': this.fields.birthdate && this.fields.birthdate.valid }">
                            <label for="birthdate" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.birthdate') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('postal_code'), 'has-success': this.fields.postal_code && this.fields.postal_code.valid }">
                            <label for="postal_code" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.postal_code') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('alley'), 'has-success': this.fields.alley && this.fields.alley.valid }">
                            <label for="alley" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.alley') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('plate'), 'has-success': this.fields.plate && this.fields.plate.valid }">
                            <label for="plate" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.plate') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('street'), 'has-success': this.fields.street && this.fields.street.valid }">
                            <label for="street" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.street') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('city'), 'has-success': this.fields.city && this.fields.city.valid }">
                            <label for="city" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.city') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('sex'), 'has-success': this.fields.sex && this.fields.sex.valid }">
                            <label for="sex" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.sex') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('university'), 'has-success': this.fields.university && this.fields.university.valid }">
                            <label for="university" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.university') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('profession'), 'has-success': this.fields.profession && this.fields.profession.valid }">
                            <label for="profession" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.profession') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('phone'), 'has-success': this.fields.phone && this.fields.phone.valid }">
                            <label for="phone" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.phone') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('confirm'), 'has-success': this.fields.confirm && this.fields.confirm.valid }">
                            <label for="confirm" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.confirm') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('status_id'), 'has-success': this.fields.status_id && this.fields.status_id.valid }">
                            <label for="status_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.status_id') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('role_id'), 'has-success': this.fields.role_id && this.fields.role_id.valid }">
                            <label for="role_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.role_id') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
                        ...
                        <div class="form-group row align-items-center" :class="{'has-danger': errors.has('image_name'), 'has-success': this.fields.image_name && this.fields.image_name.valid }">
                            <label for="image_name" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.image_name') }}</label>
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
