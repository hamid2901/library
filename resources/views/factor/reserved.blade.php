...
<div class="col-md-4">
    ...
    @else
    <div class="well">
        <form action="/factor/deleteReserve" method="POST">
            {{ csrf_field() }}
            <button id="" value='{!! Auth::user()->id !!}' name="user" style="" class="btn btn-lg btn-danger">
                حذف رزرو
                &nbsp<i class="fas fa-trash-alt"></i></button>
        </form>
    </div>
    @endif
<div class="well">
